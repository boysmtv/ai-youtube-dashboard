  ...
  return [
    {
      ...
      label: "Buat Video",
      status: "done",
      explanation: "Video baru dibuat dari halaman ini.",
    ...
    },
    {
      ...
      explanation: "Lihat video yang masih menunggu atau sedang diproses.",
  ...
  return [
    {
      ...
      explanation: "Pilih channel, masukkan ide, lalu simpan ke antrian.",
      recommendedAction: "Buat video baru",
      targetLink: "/queue#create-video",
    ...
    },
    {
      ...
      explanation: "Lihat video yang sedang diproses atau masih menunggu giliran.",
      recommendedAction: "Lihat antrian",
      targetLink: "/queue#antrian",
