...
const STATUS_LABELS: Record<string, string> = {
  queued: "Menunggu",
  searching: "Sedang membuat 1 video",
  generating_script: "Sedang membuat 1 video",
  pending: "Menunggu",
  generating_voice: "Sedang Diproses",
  generating_visual: "Sedang Diproses",
  rendering: "Sedang Diproses",
  finalizing: "Sedang Diproses",
  uploading: "Sedang Diproses",
  processing: "Sedang Diproses",
  ready_for_approval: "Menunggu Persetujuan",
  approval_required: "Menunggu Persetujuan",
  approved_waiting_schedule: "Menunggu Jadwal Upload",
  scheduled_upload: "Menunggu Jadwal Upload",
