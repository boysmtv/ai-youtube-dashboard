...
export function ApprovalList({ approvals }: Readonly<{ approvals: ApprovalAudit[] }>) {
  return (
    <div className="grid gap-3">
      {approvals.length === 0 ? (
        <div className="ta-empty">No approval history yet.</div>
      ) : (
          ...
          <article key={approval.id} className="ta-panel p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <h3 className="mt-2 text-lg font-semibold text-gray-900">Approval recorded</h3>
              </div>
            ...
            <p className="mt-2 text-gray-700">{approval.approval_reason || "No reason recorded."}</p>
